"""
Bandwidth Stress Script for fyp-vm2-1

Generates sustained TX network traffic (~60 MB/s) from the fyp-vm2-1 container
to exceed the autoscaler's BW_THRESHOLD (50 MB/s).
Press Ctrl+C to stop.

Usage:
    python tests/bw_stress_vm2.py
"""
